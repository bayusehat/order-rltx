	...
	<div id="page-wrapper">
		<div class="row">
			<div class="col-md-12 col-sm-12">
				<div class="card">
				   	<h3> Data Omset Penjualan by Sales </h3>
				    	<hr>
				    	<div class="row">
							<div class="col-md-12 col-sm-12">
						            	...
						            	$no = 1;
						            		foreach ($sales as $data) {
						            			...
						            			<tr>
						            				...
						            				<td>
						            					<a href="'.base_url().'index.php/admin/penjualan_by_sales/'.$data->id_sales.'" class="btn btn-info btn-sm"><i class="fa fa-eye"></i> Lihat Penjualan</a>
						            					<a href="'.base_url().'index.php/admin/cetak_penjualan_by_sales/'.$data->id_sales.'" class="btn btn-success btn-sm"><i class="fa fa-print"></i> Cetak Omset Penjualan</a>
						            				</td>
						            			</tr>
						            			';
						            			}
