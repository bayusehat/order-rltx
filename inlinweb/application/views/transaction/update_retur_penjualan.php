										...
										if($data->subtotal_retur > 0 && $data->deleted == 0){
											echo'
												<tr>
									                ...
									                <td>
									                	<input type="number" name="qty_jual[]" value="'.$data->jumlah_jual.'" class="form-barang qtypenjualan input-sm" id="" required>
									                </td>
									                 <td>
									                	<input type="number" name="qty_retur[]" value="'.$data->jumlah_retur.'" class="form-barang input-sm qtyretur" id="" required>
									                </td>
									                <td>
