							...
							<table class="table table-striped table-bordered table-sm" id="myTable">
								...
								<tbody>
									...
									echo'<tr>
						                ...
						                <td>
						                	<input type="text" name="subtotal_retur[]" class="form-barang subtotal input-sm" id="" required readonly>
						                </td>
						                <td>
				            		...
				            		foreach ($retured_items as $data) {
				            			...
				            			<tr>
				            				...
				            				<td>
				            					...
				            					<a href="'.base_url().'index.php/admin/to_update_retur_pembelian/'.$data->id_retur_pembelian.'" class="btn btn-success btn-sm"><i class="fa fa-sign-in-alt"></i> Ubah Retur</a>
				            				</td>
				            			</tr>
				            			';
				            			}
