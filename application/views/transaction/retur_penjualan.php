		        ...
		        <div class="row">
		            <div class="col-lg-4 col-md-4 col-sm-4">
		            	<div class="form-group">
		            		...
		            		<input type="hidden" name="id_penjualan" value="<?php echo $this->uri->segment(3);?>">
				            		...
				            		foreach ($retur_items as $data) {
				            			...
				            			<tr>
				            				...
				            				<td>
				            					...
				            					<a href="'.base_url().'index.php/admin/to_update_retur_penjualan/'.$data->id_retur_penjualan.'" class="btn btn-warning btn-sm"><i class="fa fa-sign-in-alt"></i> Batalkan Retur</a>
				            					<a href="'.base_url().'index.php/transaction/hapus_retur_penjualan/'.$data->id_retur_penjualan.'" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Hapus Retur</a>
				            				</td>
				            			</tr>
				            			';
				            			}
