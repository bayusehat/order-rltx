...
<table width="100%">
	...
	<tr>
		...
		<td>Nomor Retur</td>
		<td>:</td>
		<td><?php echo $cetak_retur->no_retur_pembelian;?></td>
	</tr>
	<tr>
		<td>No. 2 Surabaya ,0895364791</td>
		<td>Tanggal Retur</td>
		<td>:</td>
		<td><?php echo date('d F Y',strtotime($cetak_retur->tanggal_retur_pembelian));?></td>
	</tr>
	<tr>
		<td></td>
		<td>Nomor Penjualan  </td>
		<td>:</td>
		<td><?php echo $cetak_retur->nomor_pembelian;?></td>
	</tr>
	<tr>
		<td></td>
		<td>Supplier </td>
		<td>:</td>
		<td><?php echo $cetak_retur->nama_supplier;?></td>
	</tr>
</table>
<br>
...
<table width="100%">
	...
	<tr>
		...
		<td>:</td>
		<td class="t-right"><strong><?php echo 'Rp '.number_format($cetak_retur->total_retur_pembelian);?></strong></td>
	</tr>
</table>
