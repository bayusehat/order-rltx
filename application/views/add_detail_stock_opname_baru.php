		...
		<div id="content-wrapper" class="group">
			<div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <a href="<?php echo base_url();?>index.php/admin/detail_stock_opname_baru/<?php echo $this->uri->segment(3);?>" class="btn btn-danger right"><i class="fa fa-arrow-left"></i> Kembali</a>
                        </div>
                    </div>
                <br>
			<div class="row">
				<div class="col-md-12 col-sm-12">
					<div class="panel panel-info">
			            <div class="panel-heading">Input Stock Opname</div>
				            <form method="post" action="<?php echo base_url();?>index.php/transaction/add_detail_stock_opname_baru_run/<?php echo $this->uri->segment(3);?>" id="form_barang">
