...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url();?>assets/spada/css/dataTables.bootstrap.min.css" type="text/css">
    ...
    <script src="<?php echo base_url();?>assets/spada/js/sweetalert/sweetalert2@7.js"></script>
    <script src="<?php echo base_url();?>assets/spada/js/jquery-1.9.1.min.js"></script>
    <script src="<?php echo base_url();?>assets/spada/js/jquery-ui-1.11.0.js"></script>
    <link rel="stylesheet" href="<?php echo base_url();?>assets/spada/css/jquery-ui-1.11.4.css">
    ...
    <script type="text/javascript">
        function changePassword() {
            ...
            var password = $("#password_dash").val();
            var confirm_password = $("#confirm_password_dash").val();

            if(password == "" && confirm_password== ""){
                $('#gagal_ubah').html("Password dan confirm password tidak boleh kosong").slideDown('slow');
        ...
        function valid() {
            if($("#password_dash").val() != $("#confirm_password_dash").val()){
                $("#notif_dash").html('Not Matching!').css('color','red');
            }else{
                $("#notif_dash").html('Matching!').css('color','green');
            }
        }
    ...
    <div id="main" class="group">
        <div id="left-panel" class="col">
            ...
            <div id="left-navigation">
                <ul class="main-menu">
                    <li class="menu-item">
                        <a href="<?php echo base_url();?>index.php/admin"><i class="fa fa-tachometer-alt"></i>Dashboard</a>
                    </li>
                    <?php 
                    ...
                    <li class="menu-item">
                            ...
                            <ul class="sub-menu">    
                            	<li class="sub-menu-item">
                                    <a href="<?php echo base_url();?>index.php/admin/giro_masuk">Data Giro Masuk</a>
                                </li>
                                <li class="sub-menu-item">
                                    <a href="<?php echo base_url();?>index.php/admin/giro_keluar">Data Giro Keluar</a>
                                </li>
                            </ul>
                        </li>
                    <li class="menu-item">
                    ...
                    <li class="menu-item">
                        ...
                        <ul class="sub-menu">
                            <li class="sub-menu-item">
                                <a href="#" id="change">Change Password</a>
                            </li>
                        </ul>
                    </li>
                    <li class="menu-item">
                        <a href="<?php echo base_url();?>index.php/admin/logout" style="color: red" onclick="return confirm('Apakah Anda yakin ingin keluar?');"><i class="fa fa-sign-out-alt"></i>Logout</a>
                    </li>
                </ul>
            </div>
        </div>
                                ...
                                <div class="modal-content">
                                  <div class="modal-header">
                                      <div class="row">
                                        <div class="col-md-6 col-sm-6">
                                            <h4 class="modal-title" id="exampleModalLabel">Change Password <?php echo $this->session->userdata('nama_user');?></h4>
                                        </div>
                                        <div class="col-md-6 col-sm-6">
                                  ...
                                  <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="password" name="password" id="password_dash" class="form-control" placeholder="Password">
                                        </div>
                                        <div class="form-group">
                                            <label>Confirm New Password</label>
                                            <input type="password" name="confirm_password" id="confirm_password_dash" class="form-control" placeholder="Confirm Password" onkeyup="valid()">
                                            <div id="notif_dash"></div>
                                        </div>
                                    </div>
